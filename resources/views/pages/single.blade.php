				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							...
							<li><a href="portfolio" class="hvr-sweep-to-bottom">Portfolio</a></li>
							<li><a href="short-codes" class="hvr-sweep-to-bottom">Short Codes</a></li>
							<li><a href="mail" class="hvr-sweep-to-bottom">Mail Us</a></li>
						</ul>
					</nav>
				</div>
				<!-- /.navbar-collapse -->

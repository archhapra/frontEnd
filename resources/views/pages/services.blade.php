		...
		<div class="col-md-6 agile_services_bottom_grid_left">
			...
			<div class="agile_services_bottom_grid_left_grids">
				<div class="col-md-6 agile_services_bottom_grid_left_grid">
					...
					<a href="single">autem vel eum iure</a>
					<p>Ut enim ad minima veniam, quis nostrum exercit.</p>
				</div>
				<div class="col-md-6 agile_services_bottom_grid_left_grid">
					<span class="glyphicon glyphicon-move" aria-hidden="true"></span>
					<a href="single">ea voluptate velit</a>
					<p>Ut enim ad minima veniam, quis nostrum exercit.</p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="agile_services_bottom_grid_left_grids">
				<div class="col-md-6 agile_services_bottom_grid_left_grid">
					...
					<a href="single">minima veniam eum</a>
					<p>Ut enim ad minima veniam, quis nostrum exercit.</p>
				</div>
				<div class="col-md-6 agile_services_bottom_grid_left_grid">
					<span class="glyphicon glyphicon-wrench" aria-hidden="true"></span>
					<a href="single">quis nostrum exer</a>
					<p>Ut enim ad minima veniam, quis nostrum exercit.</p>
				</div>
				<div class="clearfix"> </div>
			</div>
		...
		<div class="container">
			...
			<div class="wthree_features_services_grids">
				<div class="col-md-4 wthree_features_services_grid">
					...
					<h4><a href="single">tenetur sapiente delectus</a></h4>
				...
				<div class="col-md-4 wthree_features_services_grid">
					...
					<h4><a href="single">voluptat maiores alias</a></h4>
					<p>Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis 
						voluptatibus maiores alias consequatur aut perferendis.</p>
					<div class="more m1">
						<a href="single" class="button--aylen button--round-l button--text-thick">Learn More...</a>
				...
				<div class="col-md-4 wthree_features_services_grid">
					...
					<h4><a href="single">aut reiciendis alias</a></h4>
					<p>Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis 
						voluptatibus maiores alias consequatur aut perferendis.</p>
					<div class="more m1">
						<a href="single" class="button--aylen button--round-l button--text-thick">Learn More...</a>
